...
public class CommentListModelTS {
    ...
    private String msg;
    private List<CommentWorksListBeanTS> commentWorksList;


    public CommentListModelTS(String msg, List<CommentWorksListBeanTS> commentWorksList) {
        this.msg = msg;
    ...
    public List<CommentWorksListBeanTS> getCommentWorksList() {
        return commentWorksList;
    }

    public void setCommentWorksList(List<CommentWorksListBeanTS> commentWorksList) {
        this.commentWorksList = commentWorksList;
    }
